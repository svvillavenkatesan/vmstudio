...
class TTSLocalConfig(BaseModel):
    ...
    voice: str = Field(default="ta-IN-PallaviNeural", description="Edge TTS voice ID")
...
class ImageSubConfig(BaseModel):
    ...
    prompt_prefix: str = Field(
        default="cinematic Tamil visual storytelling, authentic, respectful, text-free imagery",
...
class TemplateConfig(BaseModel):
    ...
    default_template: str = Field(
        default="1080x1920/image_tamil_culture.html",
